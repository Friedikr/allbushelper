...
getOption("repos")
install.packages(c("dplyr", "haven", "ggplot2"), repos = "https://cloud.r-project.org")
remotes::install_github("Friedikr/allbushelper") # ERROR: lazy loading failed for package ‘allbushelper’: I tried to fix it but did not work out.
```
